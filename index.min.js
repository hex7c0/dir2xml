...
function wrapper(my) {
    ...
    function simple(h, f) {
        var body;
        return body = dir_sync(my.root, h, ""), f && (body += f), body;
    }
    ...
    function dir_sync(prova, heads, afters) {
        ...
        if (stat) {
            ...
            if (files) for (var i = 0, ii = files.length; ii > i; i++) {
                var file = files[i];
...
function dir(root, opt) {
    ...
    var options = opt || Object.create(null), my = {
        ...
        dotfiles: options.dotfiles === !1 ? !1 : !0,
        cache: options.cache === !1 ? !1 : !0,
        json: Boolean(options.json),
        hash: options.hash === !1 ? !1 : String(options.hash || "md5")
    };
    return wrapper(my);
}
